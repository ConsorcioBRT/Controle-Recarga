...
model psq_rsp {
UndId Int // Identificado da Unidade
...
SttId Int @default(1) // Status Registro
UsrIdAlt Int // Id Usuário que cadastrou
DtaAlt DateTime @default(now()) @updatedAt @db.Timestamp(0) // Data Cadastro
MtvDel String? @db.VarChar(250) // Motivo da deleção

stt stt @relation(fields: [SttId], references: [SttId], onUpdate: Restrict, map: "FK_trn_Stt_SttId")
usr usr @relation(fields: [UsrIdAlt], references: [UsrId], onUpdate: Restrict, map: "FK_trn_Usr_UsrId")

@@index([SttId], map: "FK_trn_Stt_SttId")
@@index([UsrIdAlt], map: "FK_trn_Usr_UsrId")
}
...
trn trn[] @relation(map: "FK_trn_Usr_UsrId")
}
...
DataInicio DateTime? @db.DateTime @map("DataInicio")
DataFinal DateTime? @db.DateTime @map("DataFinal")
...
model VwTurnoAtual {
DtaAtu DateTime @db.Timestamp(6) @map("DtaAtu")
DtaOpe DateTime @db.Date @map("DtaOpe")
TrnId String @id @db.VarChar(1) @map("TrnId")
InicioTurno DateTime @db.Timestamp(6) @map("InicioTurno")
FimTurno DateTime @db.Timestamp(6) @map("FimTurno")
...
model psq_rsp {
  ...
  EqpItmId    Int?
  PsqPrgId    Int
  PsqRspId    Int           @id @default(autoincrement())
  PsqRsp      Int
  PsqDth      String?       @db.VarChar(250)
  SttId       Int           @default(1)
  UsrIdAlt    Int
  DtaAlt      DateTime      @default(now()) @db.Timestamp(0)
  MtvDel      String?       @db.VarChar(250)
...
model trn {
  TrnId    Int      @id @default(autoincrement())
  Trn      String   @db.VarChar(50)
  TrnIni   DateTime @db.Time(0)
  TrnFin   DateTime @db.Time(0)
  SttId    Int      @default(1)
  UsrIdAlt Int
  DtaAlt   DateTime @default(now()) @updatedAt @db.Timestamp(0)
  MtvDel   String?  @db.VarChar(250)
...
model psq_rsp_fto {
  PqsRspFto_id Int      @id @default(autoincrement())
  PsqRspId     Int
  PqsRspFtoUrl String?  @db.Text
  SttId        Int      @default(1)
  UsrIdAlt     Int
  DtaAlt       DateTime @default(now()) @db.Timestamp(0)
  MtvDel       String?  @db.VarChar(250)
  stt          stt      @relation(fields: [SttId], references: [SttId], onUpdate: Restrict, map: "FK_psq_rsp_fto_Stt_SttId")
  usr          usr      @relation(fields: [UsrIdAlt], references: [UsrId], onUpdate: Restrict, map: "FK_psq_rsp_fto_Usr_UsrId")
  psq_rsp      psq_rsp  @relation(fields: [PsqRspId], references: [PsqRspId], onUpdate: Restrict, map: "FK_psq_rsp_fto_psq_prg_PsqRspId")

  @@index([SttId], map: "FK_psq_rsp_fto_Stt_SttId")
  @@index([UsrIdAlt], map: "FK_psq_rsp_fto_Usr_UsrId")
  @@index([PsqRspId], map: "FK_psq_rsp_fto_psq_prg_PsqRspId")
}

/// This model or at least one of its fields has comments in the database, and requires an additional setup for migrations: Read more: https://pris.ly/d/database-comments
model brt {
  BrtId    Int      @id @default(autoincrement())
  BrtNme   String   @db.VarChar(50)
  SttIdAtu Int      @default(1)
  UsrIdAlt Int
  DtaAlt   DateTime @default(now()) @db.Timestamp(0)
  MtvDel   String?  @db.VarChar(250)

  @@index([BrtNme], map: "Idx_Brt")
}
...
/// This model or at least one of its fields has comments in the database, and requires an additional setup for migrations: Read more: https://pris.ly/d/database-comments
model psq_tpo_itm {
  PsqTpoItmId Int      @id @default(autoincrement())
  BrtId       Int
  PsqTpoId    Int
  EqpItmId    Int
  SttId       Int      @default(1)
  ...
  DtaAlt      DateTime @default(now()) @db.Timestamp(0)
  MtvDel      String?  @db.VarChar(250)
  eqp_itm     eqp_itm  @relation(fields: [EqpItmId], references: [EqpItmId], onUpdate: Restrict, map: "FK_PsqTpoItm_EqpItmId")
  stt         stt      @relation(fields: [SttId], references: [SttId], onUpdate: Restrict, map: "FK_PsqTpoItm_Stt_SttId")
  usr         usr      @relation(fields: [UsrIdAlt], references: [UsrId], onUpdate: Restrict, map: "FK_PsqTpoItm_Usr_UsrId")

  @@index([EqpItmId], map: "FK_PsqTpoItm_EqpItmId")
  @@index([SttId], map: "FK_PsqTpoItm_Stt_SttId")
  @@index([UsrIdAlt], map: "FK_PsqTpoItm_Usr_UsrId")
}
